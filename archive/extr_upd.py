...
FOLDER = "usda-nurseryandseedcatalog"
COLLLECTION = "usda-nurseryandseedcatalog"

def get_data(years, subjects = None, collection:str=None):
    data = []
    ...
    for page in range(1, max_p):
        ...
        response = fetch_data_with_params(years=year, subjects=subjects, page=page, collection=collection)
...
if __name__ == "__main__":
    ...
    print("Total Years Buckets :: ", len(years_agg_buckets), years_agg_buckets)
    ...
    for year in years_agg_buckets:
        ...
        if year['total_sum'] > 10000:
            ...
            continue
        # continue
        data = get_data(year, collection=COLLLECTION)
    ...
    for year_bucket in extra_data_year:
        ...
        for subject_bucket in subjects_agg_buckets:
            ...
            data = get_data(year_bucket, subjects=subjects, collection=COLLLECTION)
